...
namespace Imps.Services.CommonV4
{
	...
	public sealed class Database
	{
		...
		private class OperationContext
		{
			...
			public DatabaseObserverItem Observer;
		}

		private OperationContext Prepare(string info, string spName, string[] parameters, object[] values)
		{
		...
		private void OnException(OperationContext ctx, Exception ex)
		{
			ctx.Ex = ex;
		...
		private void OnFinally(OperationContext ctx)
		{
