...
namespace Imps.Services.CommonV4
{
    ...
    public static class SqlUtils
    {
        ...
        /// <returns></returns>
        public static string ConvertToCsv(IEnumerable list, bool bracked)
        {
            return ConvertToCsv(list, string.Empty, bracked);
        }
        ...
        /// <param name="bracketed">是否被()包围</param>
        /// <returns></returns>
        public static string ConvertToQuotedCsv(IEnumerable list, bool bracked)
        {
            return ConvertToCsv(list, "'", bracked);
        }
